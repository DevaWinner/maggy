...
<footer class="s-footer">
    <div class="row s-footer__content">
        <div class="column xl-6 lg-6 md-12 s-footer__block s-footer__about">
            <h3>About Magdalene</h3>
            <p>
            I specialize in helping brands connect with their audiences and achieve measurable growth. My approach combines creative strategy, data-driven insights, and hands-on execution to deliver campaigns that make an impact.
            </p>
        </div>
    ...
    <div class="row s-footer__bottom">
        <div class="column xl-6 lg-12">
            <ul class="s-footer__social social-list">
                <li>
                    <a href="https://www.facebook.com/archibong.magdalene" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill:rgba(0, 0, 0, 1);transform:;-ms-filter:"><path d="M20,3H4C3.447,3,3,3.448,3,4v16c0,0.552,0.447,1,1,1h8.615v-6.96h-2.338v-2.725h2.338v-2c0-2.325,1.42-3.592,3.5-3.592 c0.699-0.002,1.399,0.034,2.095,0.107v2.42h-1.435c-1.128,0-1.348,0.538-1.348,1.325v1.735h2.697l-0.35,2.725h-2.348V21H20 c0.553,0,1-0.448,1-1V4C21,3.448,20.553,3,20,3z"></path></svg>
                        <span class="u-screen-reader-text">Facebook</span>
                    </a>
                </li>
                <li>
                    <a href="https://x.com/ellarchibong?t=YXsKfmQk-ZFhhdGXrVaEbA&s=09" target="_blank">
                        ...
                        <span class="u-screen-reader-text">X formerly Twitter</span>
                    </a>
                </li>
                <li>
                    <a href="https://www.instagram.com/archibong_daniella?igsh=d2twN3M1anIzdjRq" target="_blank">
        ...
        <div class="column xl-6 lg-12">
            <p class="ss-copyright">
                <span>© Copyright Magdalene 2025</span>
                <span>Theme design by <a href="https://www.styleshout.com/">StyleShout</a></span>
            </p>
        </div>
	...
	const mountComponent = (selector, template) => {
